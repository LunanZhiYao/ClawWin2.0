import { D as setVerbose, Et as expandHomePrefix, F as getLogger, H as isNixMode, I as getResolvedLoggerSettings, J as resolveGatewayPort, M as isRich, N as theme, P as getChildLogger, V as STATE_DIR, W as resolveConfigPath, d as setConsoleTimestampPrefix, et as resolveStateDir, ft as getActivePluginRegistry, g as defaultRuntime, it as DEFAULT_CHAT_CHANNEL, j as colorize, n as isTruthyEnvValue, nt as CHANNEL_IDS, o as createSubsystemLogger, q as resolveGatewayLockDir, r as logAcceptedEnvOption, s as runtimeForLogger, u as setConsoleSubsystemFilter, z as CONFIG_PATH } from "./entry.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BnuyZ2Wy.js";
import "./logging-6s9Eiv1e.js";
import "./accounts-ATQywTNB.js";
import "./send-dCoRHQjc.js";
import "./send-BrjKyPg_.js";
import { $ as setGatewaySigusr1RestartPolicy, $n as resolveTtsApiKey, $t as pruneExpiredPending, A as capArrayByJsonBytes, An as isAbortTrigger, Ar as DEFAULT_INPUT_FILE_MAX_CHARS, B as resolveOutboundTarget, Bn as onAgentEvent, Br as extractImageContentFromSource, Bt as refreshRemoteNodeBins, C as loadCombinedSessionStoreForGateway, Cr as applyModelOverrideToSessionEntry, Ct as loadOpenClawPlugins, D as resolveSessionModelRef, Dn as formatZonedTimestamp, Dr as isSystemEventContextChanged, E as resolveGatewaySessionStoreTarget, Er as enqueueSystemEvent, Et as loadProviderUsageSummary, Fn as runSubagentAnnounceFlow, Fr as DEFAULT_INPUT_PDF_MAX_PAGES, G as runWithModelFallback, Gt as rejectNodePairing, Hn as resolveAgentIdentity, Hr as estimateBase64DecodedBytes, Ht as setSkillsRemoteRegistry, I as ensureOutboundSessionEntry, Ir as DEFAULT_INPUT_PDF_MAX_PIXELS, It as getRemoteSkillEligibility, J as deferGatewayRestartUntilIdle, Jn as registerInternalHook, Jr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Jt as updatePairedNodeMetadata, Kn as clearInternalHooks, Kt as renamePairedNode, L as resolveOutboundSessionRoute, Ln as clearAgentRunContext, Lr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Lt as primeRemoteSkillsCache, M as readSessionPreviewItemsFromTranscript, Mr as DEFAULT_INPUT_IMAGE_MAX_BYTES, Mt as readJsonBodyWithLimit, N as resolveSessionTranscriptCandidates, Nr as DEFAULT_INPUT_IMAGE_MIMES, Nt as requestBodyErrorToText, O as archiveFileOnDisk, P as stripEnvelopeFromMessages, Pn as initSubagentRegistry, Pr as DEFAULT_INPUT_MAX_REDIRECTS, Q as scheduleGatewaySigusr1Restart, Qn as isTtsProviderConfigured, Qr as stripHeartbeatToken, Qt as createAsyncLock, Rn as emitAgentEvent, Rr as DEFAULT_INPUT_TIMEOUT_MS, Rt as recordRemoteNodeInfo, S as listSessionsFromStore, St as getPluginToolMeta, T as pruneLegacyStoreKeys, Tr as parseVerboseOverride, U as resetDirectoryCache, Ut as approveNodePairing, V as resolveSessionDeliveryTarget, Vn as registerAgentRunContext, Vr as normalizeMimeList, Vt as removeRemoteNodeInfo, Wr as resolveAgentTimeoutMs, Wt as listNodePairing, X as isGatewaySigusr1RestartExternallyAllowed, Xn as getTtsProvider, Xt as generatePairingToken, Y as emitGatewayRestart, Yn as triggerInternalHook, Yt as verifyNodeToken, Z as markGatewaySigusr1RestartHandled, Zn as isTtsEnabled, Zt as verifyPairingToken, _ as buildDefaultToolPolicyPipelineSteps, _r as waitForActiveTasks, an as buildSafeExternalPrompt, ar as setTtsProvider, at as summarizeRestartSentinel, b as canonicalizeSpawnedByForAgent, bn as createReplyDispatcher, br as stopDiagnosticHeartbeat, bt as requestHeartbeatNow, c as normalizeSendPolicy, cn as isExternalHookSession, cr as OPENAI_TTS_VOICES, ct as normalizeCronJobCreate, d as runEmbeddedPiAgent, dt as normalizeOptionalAgentId, en as readJsonFile, er as resolveTtsAutoMode, et as setPreRestartDeferralCheck, f as abortEmbeddedPiRun, fr as getActiveTaskCount, ft as normalizeOptionalText, g as applyToolPolicyPipeline, gr as setCommandLaneConcurrency, hr as resetAllLanes, ht as migrateLegacyCronPayload, i as runCliAgent, in as registerSkillsChangeListener, ir as setTtsEnabled, j as readSessionMessages, jn as stopSubagentsForRequester, jr as DEFAULT_INPUT_FILE_MIMES, jt as handleSlackHttpRequest, k as archiveSessionTranscripts, kr as DEFAULT_INPUT_FILE_MAX_BYTES, l as resolveSendPolicy, ln as createReplyPrefixOptions, lt as normalizeCronJobPatch, m as waitForEmbeddedPiRunEnd, mr as getTotalQueueSize, mt as normalizeRequiredName, n as getCliSessionId, nn as writeJsonAtomic, nr as resolveTtsPrefsPath, nt as formatDoctorNonInteractiveHint, on as detectSuspiciousPatterns, or as textToSpeech, p as getActiveEmbeddedRunCount, pn as buildHistoryContextFromEntries, pt as normalizePayloadToSystemText, q as consumeGatewaySigusr1RestartAuthorization, qn as createInternalHookEvent, qr as resolveUserTimezone, qt as requestNodePairing, r as setCliSessionId, rn as getSkillsSnapshotVersion, rr as resolveTtsProviderOrder, rt as formatRestartSentinelMessage, sn as getHookType, sr as OPENAI_TTS_MODELS, st as writeRestartSentinel, tn as resolvePairingPaths, tr as resolveTtsConfig, tt as consumeRestartSentinel, u as clearSessionQueues, ut as inferLegacyName, v as createOpenClawTools, vr as CommandLane, vt as applyBrowserProxyPaths, w as loadSessionEntry, wr as applyVerboseOverride, wt as normalizeGroupActivation, x as listAgentsForGateway, xn as getTotalPendingReplies, xr as isDiagnosticsEnabled, y as resolveAnnounceTargetFromKey, yn as dispatchInboundMessage, yr as startDiagnosticHeartbeat, yt as persistBrowserProxyFiles, zn as getAgentRunContext, zr as extractFileContentFromSource, zt as refreshRemoteBinsForConnectedNodes } from "./reply-CrwRmeCr.js";
import "./media-jAjl2iil.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BecDlYW9.js";
import "./render-CC3QzhUn.js";
import "./tables-GrlK2j3a.js";
import { n as normalizePollInput } from "./polls-sXdvQw2C.js";
import { o as detectMime } from "./image-ops-DIfvMtad.js";
import "./fetch-D5DTbD03.js";
import "./tool-images-BQAYNcA_.js";
import { t as ToolInputError } from "./common-flt09mDR.js";
import "./server-context-s3xWq7m3.js";
import { n as pickPrimaryTailnetIPv6, t as pickPrimaryTailnetIPv4 } from "./tailnet-tionPlRC.js";
import { a as isTrustedProxyAddress, d as resolveGatewayListenHosts, i as isPrivateOrLoopbackAddress, l as resolveGatewayBindHost, n as isLoopbackAddress, r as isLoopbackHost, t as rawDataToString, u as resolveGatewayClientIp } from "./ws-BmKx9hzC.js";
import "./chrome-BRBns8fW.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, c as safeEqualSecret, d as enableTailscaleFunnel, f as enableTailscaleServe, i as resolveGatewayAuth, l as disableTailscaleFunnel, m as getTailnetHostname, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured, u as disableTailscaleServe } from "./auth-CjzSe-Vc.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-CTMu4lH4.js";
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-B01ecUzU.js";
import { t as movePathToTrash } from "./trash-BwRE37gV.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Cj_cxFqX.js";
import { D as isSilentReplyText, E as SILENT_REPLY_TOKEN, S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-DPvh-5xr.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, s as resolveCronStyleNow, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CnJ776JT.js";
import { G as normalizeVerboseLevel, H as normalizeReasoningLevel, L as formatThinkingLevels, R as formatXHighModelHint, U as normalizeThinkLevel, V as normalizeElevatedLevel, W as normalizeUsageDisplay, q as supportsXHighThinking } from "./pi-embedded-helpers-1VoyogxV.js";
import { A as resolveExplicitAgentSessionKey, M as resolveMainSessionKeyFromConfig, P as snapshotSessionOrigin, _ as normalizeSessionDeliveryFields, h as mergeDeliveryContext, i as loadSessionStore, j as resolveMainSessionKey, k as resolveAgentMainSessionKey, l as updateSessionStore, p as deliveryContextFromSession, t as extractDeliveryInfo } from "./sessions-BK1H0ugi.js";
import { f as registerUnhandledRejectionHandler, s as loadModelCatalog } from "./runner-DoVotVW7.js";
import "./image-CL8yvEzz.js";
import "./models-config-D1QzxgMY.js";
import { h as collectExplicitAllowlist, y as resolveToolProfilePolicy } from "./sandbox-CWeyov8H.js";
import "./routes-CaSRevJn.js";
import "./paths-jbTa_y3m.js";
import "./store-Cn-gqoH5.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-DiTZA01b.js";
import "./redact-1PNP01B_.js";
import "./tool-display-C2p-iSlz.js";
import { t as lookupContextTokens } from "./context-D5JPpgxa.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-CXT6WujF.js";
import "./send-DxMz0f-R.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-B0IaK2Lq.js";
import "./manager-BkjmfXHe.js";
import "./sqlite-DV-Oz6PD.js";
import "./retry-NBwLy5r3.js";
import "./commands-registry-CVOvB-TT.js";
import { $ as validateNodePairRequestParams, A as validateCronStatusParams, B as validateExecApprovalsNodeGetParams, Bt as verifyDeviceSignature, C as validateConfigSetParams, Ct as validateWizardCancelParams, D as validateCronRemoveParams, Dt as PROTOCOL_VERSION, E as validateCronListParams, Et as validateWizardStatusParams, F as validateDeviceTokenRevokeParams, Ft as buildDeviceAuthPayload, G as validateNodeDescribeParams, H as validateExecApprovalsSetParams, I as validateDeviceTokenRotateParams, J as validateNodeInvokeResultParams, K as validateNodeEventParams, L as validateExecApprovalRequestParams, Lt as deriveDeviceIdFromPublicKey, M as validateDevicePairApproveParams, N as validateDevicePairListParams, O as validateCronRunParams, Ot as ErrorCodes, P as validateDevicePairRejectParams, Pt as normalizeInputProvenance, Q as validateNodePairRejectParams, R as validateExecApprovalResolveParams, S as validateConfigSchemaParams, St as validateWebLoginWaitParams, T as validateCronAddParams, Tt as validateWizardStartParams, U as validateLogsTailParams, V as validateExecApprovalsNodeSetParams, W as validateModelsListParams, X as validateNodePairApproveParams, Y as validateNodeListParams, Z as validateNodePairListParams, _ as validateChatInjectParams, _t as validateTalkConfigParams, a as validateAgentWaitParams, at as validateSessionsCompactParams, b as validateConfigGetParams, bt as validateWakeParams, c as validateAgentsFilesGetParams, ct as validateSessionsPatchParams, d as validateAgentsListParams, dt as validateSessionsResolveParams, et as validateNodePairVerifyParams, f as validateAgentsUpdateParams, ft as validateSessionsUsageParams, g as validateChatHistoryParams, gt as validateSkillsUpdateParams, h as validateChatAbortParams, ht as validateSkillsStatusParams, i as validateAgentParams, it as validateSendParams, j as validateCronUpdateParams, jt as parseSessionLabel, k as validateCronRunsParams, kt as errorShape, l as validateAgentsFilesListParams, lt as validateSessionsPreviewParams, m as validateChannelsStatusParams, mt as validateSkillsInstallParams, n as formatValidationErrors, nt as validatePollParams, o as validateAgentsCreateParams, ot as validateSessionsDeleteParams, p as validateChannelsLogoutParams, pt as validateSkillsBinsParams, q as validateNodeInvokeParams, r as validateAgentIdentityParams, rt as validateRequestFrame, s as validateAgentsDeleteParams, st as validateSessionsListParams, tt as validateNodeRenameParams, u as validateAgentsFilesSetParams, ut as validateSessionsResetParams, v as validateChatSendParams, vt as validateTalkModeParams, w as validateConnectParams, wt as validateWizardNextParams, x as validateConfigPatchParams, xt as validateWebLoginStartParams, y as validateConfigApplyParams, yt as validateUpdateRunParams, z as validateExecApprovalsGetParams, zt as normalizeDevicePublicKeyBase64Url } from "./client-Csp-2oRh.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-B9XcIpQ-.js";
import { t as getChannelActivity } from "./channel-activity-zsOWc2wE.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-uECcvl-X.js";
import "./send-BE-dasjw.js";
import { C as resolveAssistantAvatarUrl, S as normalizeControlUiBasePath, b as CONTROL_UI_AVATAR_PREFIX, c as handleReset, x as buildControlUiAvatarUrl } from "./onboard-helpers-l1NHeo7i.js";
import "./prompt-style-B6Z4pIdl.js";
import "./pairing-labels-B_V5KBBy.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-DH0dSeVa.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-CRaaWHld.js";
import { f as resolveExecApprovalsSocketPath, o as normalizeExecApprovals, p as saveExecApprovals, r as ensureExecApprovals, s as readExecApprovalsSnapshot, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-DxO73AVL.js";
import "./nodes-screen-Bnn6YgFt.js";
import { t as parseAbsoluteTimeMs } from "./parse-DLMgOMDI.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-B7kU_hWM.js";
import "./delivery-queue-BTOx9sLI.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-ofysbnRa.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-17gkagHW.js";
import { t as buildChannelUiCatalog } from "./catalog-6NJF6ATM.js";
import "./note-BmK3mDX7.js";
import { t as WizardCancelledError } from "./prompts-DyRcLO9I.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DEDpe-6P.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-M0ElsYts.js";
...
import { t as buildChannelAccountSnapshot } from "./status-XEHd0yGa.js";
...
import "./lifecycle-core-DpDzkcah.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli--NpoqCZ6.js";
import "./diagnostics-B895Za_F.js";
import "./service-audit-unW23j56.js";
import "./table-CoQdktrn.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DGKP2o1l.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Dsq-lrWu.js";
import { a as isNodeCommandAllowed, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-DZ_2v6TF.js";
import { m as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-Sz8-LdAo.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-MCmtGT7n.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-DOIFQ10i.js";
import { a as resolveControlUiRootOverrideSync, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync } from "./health-format-BemPCTHE.js";
import { f as normalizeUpdateChannel, i as resolveNpmChannelTag, n as compareSemverStrings, o as DEFAULT_PACKAGE_CHANNEL, t as checkUpdateStatus } from "./update-check-PJMwKkdU.js";
import "./auth-choice-Cai1xZb-.js";
import "./github-copilot-auth-BeXkhisw.js";
import "./logging-CL5j2Kfg.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status--ISL0Ry_.js";
import { t as runOnboardingWizard } from "./onboarding-CGiqRyK4.js";
import "./tui-GvuAqDW0.js";
import "./doctor-completion-D371BUQA.js";
import { a as setGatewayWsLogStyle, i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-w6U3w7m7.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-B1e1LyJ-.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Dv-A8y_C.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-oHs2A4s3.js";
import { r as getStatusSummary } from "./status-DOynQCsk.js";
import "./node-service-RvjhtsGc.js";
import "./status.update-CNF5fdC4.js";
import { n as validateSystemRunCommandConsistency, t as formatExecCommand } from "./system-run-command-BzuoXsbJ.js";
import { t as runGatewayUpdate } from "./update-runner-CLqfQ_Rq.js";
import { n as forceFreePortAndWait } from "./ports-Cx793dSX.js";
...
async function runCronIsolatedAgentTurn(params) {
	...
	if (isFastTestEnv) skillsSnapshot = skillsSnapshot ?? {
		prompt: "",
		skills: []
	};
	else {
		...
		if (!existingSnapshot || existingSnapshot.version !== skillsSnapshotVersion) {
	...
	if (deliveryRequested && !skipHeartbeatDelivery && !skipMessagingToolDelivery) {
		...
		if (deliveryPayloadHasStructuredContent || identity || hasExplicitDeliveryTarget) try {
			const payloadsForDelivery = deliveryPayloadHasStructuredContent && deliveryPayloads.length > 0 ? deliveryPayloads : synthesizedText ? [{ text: synthesizedText }] : [];
...
async function loadVoiceWakeConfig(baseDir) {
	const existing = await readJSON(resolvePath$1(baseDir));
	if (!existing) return {
...
const chatHandlers = {
	...
	"chat.send": async ({ params, respond, context, client }) => {
		...
		console.log('[chat.send] raw attachments count:', p.attachments?.length ?? 0);
		if (p.attachments?.length > 0) { p.attachments.forEach((a, i) => { console.log(`[chat.send] raw att[${i}]:`, { type: a?.type, mimeType: a?.mimeType, fileName: a?.fileName, hasContent: typeof a?.content === 'string', contentLen: typeof a?.content === 'string' ? a.content.length : 0 }); }); }
		...
		console.log('[chat.send] after normalize:', normalizedAttachments.length, 'attachments with content');
		...
		if (normalizedAttachments.length > 0) try {
			...
			console.log('[chat.send] parsedImages:', parsedImages.length, parsedImages.map(img => ({ type: img.type, mimeType: img.mimeType, dataLen: img.data?.length ?? 0 })));
		} catch (err) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, String(err)));
			return;
		}
...
const FIELD_HELP = {
	...
	"agents.defaults.bootstrapTotalMaxChars": "Max total characters across all injected workspace bootstrap files (default: 24000).",
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CG8fT3Mm.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-DH0dSeVa.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Cj_cxFqX.js").then((n) => n.t);
...
function injectControlUiConfig(html, opts) {
	...
	const tokenScript = gatewayToken ? `<script>(function(){try{var k="openclaw.control.settings.v1";var raw=localStorage.getItem(k);var s=raw?JSON.parse(raw):{};s.token=${JSON.stringify(gatewayToken)};localStorage.setItem(k,JSON.stringify(s))}catch(e){}})()<\/script>` : '';
	if (html.includes("__OPENCLAW_ASSISTANT_NAME__")) return html;
	const headClose = html.indexOf("</head>");
	if (headClose !== -1) return `${html.slice(0, headClose)}${script}${tokenScript}${html.slice(headClose)}`;
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BTOx9sLI.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-DPvh-5xr.js").then((n) => n.n);
