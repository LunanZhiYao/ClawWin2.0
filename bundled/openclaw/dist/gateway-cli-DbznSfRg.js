...
import { B as isRich, E as getActivePluginRegistry, F as setVerbose, H as getChildLogger, U as getLogger, V as theme, W as getResolvedLoggerSettings, a as setConsoleSubsystemFilter, d as defaultRuntime, g as CHANNEL_IDS, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger, v as DEFAULT_CHAT_CHANNEL, z as colorize } from "./subsystem-BbhgPUzd.js";
import { C as shortenHomePath, D as truncateUtf16Safe, b as resolveUserPath, c as ensureDir, d as isPlainObject, r as clamp, t as CONFIG_DIR } from "./utils-Bu8JlY-C.js";
import { G as normalizeVerboseLevel, H as normalizeReasoningLevel, L as formatThinkingLevels, R as formatXHighModelHint, U as normalizeThinkLevel, V as normalizeElevatedLevel, W as normalizeUsageDisplay, q as supportsXHighThinking } from "./pi-embedded-helpers-DLeTj87G.js";
import { $ as setGatewaySigusr1RestartPolicy, $n as getTtsProvider, $r as resolveAgentTimeoutMs, $t as pruneExpiredPending, A as capArrayByJsonBytes, An as isAbortTrigger, Ar as lookupContextTokens, B as resolveOutboundTarget, Bn as onAgentEvent, Br as DEFAULT_INPUT_FILE_MIMES, Bt as refreshRemoteNodeBins, C as loadCombinedSessionStoreForGateway, Cr as stopDiagnosticHeartbeat, Ct as loadOpenClawPlugins, D as resolveSessionModelRef, Dn as formatZonedTimestamp, E as resolveGatewaySessionStoreTarget, Et as loadProviderUsageSummary, Fn as runSubagentAnnounceFlow, Fr as enqueueSystemEvent, G as runWithModelFallback, Gr as DEFAULT_INPUT_PDF_MAX_PIXELS, Gt as rejectNodePairing, Hn as resolveAgentIdentity, Hr as DEFAULT_INPUT_IMAGE_MIMES, Ht as setSkillsRemoteRegistry, I as ensureOutboundSessionEntry, Ir as isSystemEventContextChanged, It as getRemoteSkillEligibility, J as deferGatewayRestartUntilIdle, Jn as resolveUserTimezone, Jr as extractFileContentFromSource, Jt as updatePairedNodeMetadata, Kr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Kt as renamePairedNode, L as resolveOutboundSessionRoute, Ln as clearAgentRunContext, Lt as primeRemoteSkillsCache, M as readSessionPreviewItemsFromTranscript, Mr as applyModelOverrideToSessionEntry, Mt as readJsonBodyWithLimit, N as resolveSessionTranscriptCandidates, Nr as applyVerboseOverride, Nt as requestBodyErrorToText, O as archiveFileOnDisk, P as stripEnvelopeFromMessages, Pn as initSubagentRegistry, Pr as parseVerboseOverride, Q as scheduleGatewaySigusr1Restart, Qn as triggerInternalHook, Qt as createAsyncLock, Rn as emitAgentEvent, Rr as DEFAULT_INPUT_FILE_MAX_BYTES, Rt as recordRemoteNodeInfo, S as listSessionsFromStore, Sr as startDiagnosticHeartbeat, St as getPluginToolMeta, T as pruneLegacyStoreKeys, Tr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, U as resetDirectoryCache, Ur as DEFAULT_INPUT_MAX_REDIRECTS, Ut as approveNodePairing, V as resolveSessionDeliveryTarget, Vn as registerAgentRunContext, Vr as DEFAULT_INPUT_IMAGE_MAX_BYTES, Vt as removeRemoteNodeInfo, Wr as DEFAULT_INPUT_PDF_MAX_PAGES, Wt as listNodePairing, X as isGatewaySigusr1RestartExternallyAllowed, Xn as createInternalHookEvent, Xr as normalizeMimeList, Xt as generatePairingToken, Y as emitGatewayRestart, Yn as clearInternalHooks, Yr as extractImageContentFromSource, Yt as verifyNodeToken, Z as markGatewaySigusr1RestartHandled, Zn as registerInternalHook, Zr as estimateBase64DecodedBytes, Zt as verifyPairingToken, _ as buildDefaultToolPolicyPipelineSteps, _r as getTotalQueueSize, an as buildSafeExternalPrompt, ar as resolveTtsPrefsPath, at as summarizeRestartSentinel, b as canonicalizeSpawnedByForAgent, bn as createReplyDispatcher, br as waitForActiveTasks, bt as requestHeartbeatNow, c as normalizeSendPolicy, cn as isExternalHookSession, cr as setTtsProvider, ct as normalizeCronJobCreate, d as runEmbeddedPiAgent, dr as OPENAI_TTS_VOICES, dt as normalizeOptionalAgentId, en as readJsonFile, er as isTtsEnabled, et as setPreRestartDeferralCheck, f as abortEmbeddedPiRun, ft as normalizeOptionalText, g as applyToolPolicyPipeline, hr as getActiveTaskCount, ht as migrateLegacyCronPayload, i as runCliAgent, in as registerSkillsChangeListener, ir as resolveTtsConfig, j as readSessionMessages, jn as stopSubagentsForRequester, jt as handleSlackHttpRequest, k as archiveSessionTranscripts, kr as stripHeartbeatToken, l as resolveSendPolicy, ln as createReplyPrefixOptions, lr as textToSpeech, lt as normalizeCronJobPatch, m as waitForEmbeddedPiRunEnd, mt as normalizeRequiredName, n as getCliSessionId, nn as writeJsonAtomic, nr as resolveTtsApiKey, nt as formatDoctorNonInteractiveHint, on as detectSuspiciousPatterns, or as resolveTtsProviderOrder, p as getActiveEmbeddedRunCount, pn as buildHistoryContextFromEntries, pt as normalizePayloadToSystemText, q as consumeGatewaySigusr1RestartAuthorization, qr as DEFAULT_INPUT_TIMEOUT_MS, qt as requestNodePairing, r as setCliSessionId, rn as getSkillsSnapshotVersion, rr as resolveTtsAutoMode, rt as formatRestartSentinelMessage, sn as getHookType, sr as setTtsEnabled, st as writeRestartSentinel, tn as resolvePairingPaths, tr as isTtsProviderConfigured, tt as consumeRestartSentinel, u as clearSessionQueues, ur as OPENAI_TTS_MODELS, ut as inferLegacyName, v as createOpenClawTools, vr as resetAllLanes, vt as applyBrowserProxyPaths, w as loadSessionEntry, wr as isDiagnosticsEnabled, wt as normalizeGroupActivation, x as listAgentsForGateway, xn as getTotalPendingReplies, xr as CommandLane, y as resolveAnnounceTargetFromKey, yn as dispatchInboundMessage, yr as setCommandLaneConcurrency, yt as persistBrowserProxyFiles, zn as getAgentRunContext, zr as DEFAULT_INPUT_FILE_MAX_CHARS, zt as refreshRemoteBinsForConnectedNodes } from "./reply-CYMZTXlH.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-IuFI-7be.js";
import "./send-13ZakwFz.js";
import { C as resolveAssistantAvatarUrl, S as normalizeControlUiBasePath, b as CONTROL_UI_AVATAR_PREFIX, c as handleReset, x as buildControlUiAvatarUrl } from "./onboard-helpers-DsWG_ruh.js";
import "./prompt-style-_k1DA6Wp.js";
import "./pairing-labels-DRgmeoqx.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-r-Rovr3R.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-Bodo4xSf.js";
import { f as resolveExecApprovalsSocketPath, o as normalizeExecApprovals, p as saveExecApprovals, r as ensureExecApprovals, s as readExecApprovalsSnapshot, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Ds_-fx37.js";
import "./nodes-screen-BiNBeuxJ.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-duwKSJek.js";
import { t as parseAbsoluteTimeMs } from "./parse-DbwfoyR_.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Ct5caPKx.js";
import "./delivery-queue-CJGN_Wrf.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, s as resolveCronStyleNow, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-EXUmW0eL.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-DGzocYMK.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BF1HHl7_.js";
import { t as forceFreePortAndWait } from "./ports-D-gtHDZo.js";
import "./program-context-BvTP81tH.js";
import { t as buildChannelUiCatalog } from "./catalog-KgzGgAlY.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CZbSlnxZ.js";
...
import { t as resolveChannelDefaultAccountId } from "./helpers-xs7eKOjH.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-C3SNAQsT.js";
...
import { t as buildChannelAccountSnapshot } from "./status-DcPHS_Li.js";
...
import "./lifecycle-core-BHn1S_XV.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-Cm3zitS9.js";
import "./diagnostics-C0LsoJq7.js";
import "./service-audit-BGxDzmd3.js";
import "./table-BLMSXjAe.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-_z0-cE6J.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-3Z_vz38U.js";
import { a as isNodeCommandAllowed, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-D0REnQlQ.js";
import { m as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-EO5vGuAg.js";
import { c as startHeartbeatRunner, i as styleHealthChannelLine, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-v46l7iF9.js";
import { a as resolveControlUiRootOverrideSync, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync } from "./health-format-Kwo85CEL.js";
import { f as normalizeUpdateChannel, i as resolveNpmChannelTag, n as compareSemverStrings, o as DEFAULT_PACKAGE_CHANNEL, t as checkUpdateStatus } from "./update-check-BmqZh2fU.js";
import "./auth-choice-B9qgRdsf.js";
import "./github-copilot-auth-BiaSo_ZY.js";
import "./logging-DgGsK4TF.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-BAZV_hb_.js";
import { t as runOnboardingWizard } from "./onboarding-DmzWwzdf.js";
import "./tui-DMcWwYZ_.js";
import "./doctor-completion-EnSbbc2I.js";
import { a as setGatewayWsLogStyle, i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-Bets3CvZ.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DHLN-_WM.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-CPPXXRp_.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BmGBeA0X.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-DMu-ucrG.js";
import { n as getStatusSummary } from "./status-DDg1IFyC.js";
import "./node-service-B_KSNg6K.js";
import "./status.update-BRy8t_EY.js";
import { n as validateSystemRunCommandConsistency, t as formatExecCommand } from "./system-run-command-DB49Tx-B.js";
import { t as runGatewayUpdate } from "./update-runner-qRF2UdqA.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B8pto7W4.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-r-Rovr3R.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-duwKSJek.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CJGN_Wrf.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-N3OqJwZc.js").then((n) => n.n);
